...
class EyeMuscles extends StatefulWidget {
  @override
  _EyeMusclesState createState() => _EyeMusclesState();
}

class _EyeMusclesState extends State<EyeMuscles> {
  String exName = "EyeMuscles";
...
//CFT
  ...
  Widget build(BuildContext context) {
    ...
    // if ((provider.productID == 'monthly_subscription_standard') ||
    //     (provider.productID == 'yearly_subscription_standard') ||
    //     (provider.productID == 'monthly_subscription_premium') ||
    ...
    //   paid = false;
    // }
    print('This Is Eye Muscels: $paid');
    return WillPopScope(
      onWillPop: () {
            ...
            Container(
              ...
              child: GridView(
                ...
                children: <Widget>[
                  ...
                  //     MaterialPageRoute(builder: (context) => ChoosePlan('em')))
                  // :Navigator.push(
                  //       context,
                  //       MaterialPageRoute(
