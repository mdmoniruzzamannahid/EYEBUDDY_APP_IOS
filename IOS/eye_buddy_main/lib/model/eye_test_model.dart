...
List<TestModel> testModels = <TestModel>[
  TestModel(
      link:
          'https://www.mdcalc.com/visual-acuity-testing-snellen-chart#why-use',
      id: 1,
      logo: 'assets/svg/eye_test/visual_aquity_test.svg',
      title: 'Visual Acuity Test',
      desc:
          'The visual acuity test checks how well you see the details of a letter or symbol from a specific distance.',
  ...
  TestModel(
      link:
          'https://www.westchesterhealth.com/blog/are-you-color-blind-heres-how-to-tell/',
      id: 5,
