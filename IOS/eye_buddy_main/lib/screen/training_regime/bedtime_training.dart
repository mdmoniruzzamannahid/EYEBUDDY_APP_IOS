...
import 'package:eye_buddy/screen/training_regime/emdr/bedtime_tips.dart';
...
class BedtimeTraining extends StatefulWidget {
  @override
  _BedtimeTrainingState createState() => _BedtimeTrainingState();
}

class _BedtimeTrainingState extends State<BedtimeTraining> {
  String uid;
  String aCollection = "AcBT";

  List<String> videoList = ['fKv1k254_kk'];
          ...
          child: Column(
            children: [
              InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => ExerciseSet('bedtime')));
                },
              ...
              InkWell(
                onTap: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => BedTimeTips()));
                },
