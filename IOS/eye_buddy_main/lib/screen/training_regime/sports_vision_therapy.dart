...
import 'package:eye_buddy/screen/training_regime/emdr/sports_vision_tips.dart';
...
class SportVisonTherapy extends StatefulWidget {
  @override
  _SportVisonTherapyState createState() => _SportVisonTherapyState();
}

class _SportVisonTherapyState extends State<SportVisonTherapy> {
  String uid;
  String aCollection = "AcSVT";
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => ExerciseSet('sports')));
                },
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => SportVisionTips()));
                },
