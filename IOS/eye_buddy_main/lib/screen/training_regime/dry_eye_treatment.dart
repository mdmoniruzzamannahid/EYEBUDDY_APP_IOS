import 'package:eye_buddy/screen/training_regime/emdr/dry_eye_tips.dart';
...
import 'package:eye_buddy/screen/training_regime/survey_chart.dart';
...
class DryEyesTreatment extends StatefulWidget {
  @override
  _DryEyesTreatmentState createState() => _DryEyesTreatmentState();
}

class _DryEyesTreatmentState extends State<DryEyesTreatment> {
  String uid;
  String aCollection = "AcDET";
          ...
          child: Column(
            children: [
              InkWell(
                onTap: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => SurveyChart()));
                },
                child: _traing_card(h, w, 'Survey_Chart', 'Survey Chart'),
              ),
              _traing_card(h, w, 'Treatment Plan', 'Treatment Plan'),
              InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => ExerciseSet('dryeye')));
                },
              ...
              InkWell(
                onTap: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => DryEyeTips()));
                },
