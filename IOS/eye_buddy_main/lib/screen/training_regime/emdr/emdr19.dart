...
class HandTappingPage2 extends StatefulWidget {
  @override
  _HandTappingPage2State createState() => _HandTappingPage2State();
}

class _HandTappingPage2State extends State<HandTappingPage2>
    ...
    if (controller.isCompleted == true) {
      SchedulerBinding.instance.addPostFrameCallback((_) {
        Navigator.pushAndRemoveUntil(
            context,
            MaterialPageRoute(
                builder: (BuildContext context) => ExerciseComplete()),
            (route) => false);
      });
    }
    return WillPopScope(
      onWillPop: () => Navigator.push(
          context, MaterialPageRoute(builder: (context) => WhatCame())),
      child: Scaffold(
        appBar: AppBar(
          centerTitle: true,
          title: Text(
          ...
          leading: InkWell(
              ...
              onTap: () {
                ...
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => WhatCame()));
              }),
          actions: <Widget>[
            Row(
              children: <Widget>[
