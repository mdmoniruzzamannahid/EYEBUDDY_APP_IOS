...
class WhatMore extends StatefulWidget {
  @override
  _WhatMoreState createState() => _WhatMoreState();
}

class _WhatMoreState extends State<WhatMore> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    if (controller.isCompleted == true) {
      // Navigator.push(
      //     context, MaterialPageRoute(builder: (context) => LeftRight(id: 3)));
    ...
    return WillPopScope(
      onWillPop: () => Navigator.push(
          context, MaterialPageRoute(builder: (context) => HappenedThatDay())),
      child: Scaffold(
