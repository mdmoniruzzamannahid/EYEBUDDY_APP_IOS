...
class WhatCame extends StatefulWidget {
  @override
  _WhatCameState createState() => _WhatCameState();
}

class _WhatCameState extends State<WhatCame> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () => Navigator.push(
          context, MaterialPageRoute(builder: (context) => HandTappingPage())),
      child: Scaffold(
