...
class LoaderImageMemory extends StatefulWidget {
  @override
  _LoaderImageMemoryState createState() => _LoaderImageMemoryState();
}

class _LoaderImageMemoryState extends State<LoaderImageMemory>
  ...
  Widget build(BuildContext context) {
    ...
    // print('This Is Counter Text $countText');
    // print('This Is progress $progress');
    // print('This Is controller value${controller.value}');

    return WillPopScope(
      onWillPop: () => Navigator.push(
          context, MaterialPageRoute(builder: (context) => Memory())),
      child: Scaffold(
            ...
            children: [
              ...
              Padding(
                ...
                child: Container(
                  width: w * 0.8,
                  child: Text(
                    'Remember the image associate with the memory',
                    style: TextStyle(
                        fontSize: w * 0.05,
