...
import 'package:eye_buddy/screen/training_regime/emdr/emdr18.dart';
...
class HandTappingPage extends StatefulWidget {
  @override
  _HandTappingPageState createState() => _HandTappingPageState();
}

class _HandTappingPageState extends State<HandTappingPage>
    ...
    if (controller.isCompleted == true) {
      SchedulerBinding.instance.addPostFrameCallback((_) {
        Navigator.pushAndRemoveUntil(
            context,
            MaterialPageRoute(builder: (BuildContext context) => WhatCame()),
            (route) => false);
      });
    }
    return WillPopScope(
      onWillPop: () => Navigator.push(
          context, MaterialPageRoute(builder: (context) => HandTapping())),
      child: Scaffold(
        appBar: AppBar(
          centerTitle: true,
          title: Text(
          ...
          leading: InkWell(
              ...
              onTap: () {
                ...
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => HandTapping()));
              }),
        ),
