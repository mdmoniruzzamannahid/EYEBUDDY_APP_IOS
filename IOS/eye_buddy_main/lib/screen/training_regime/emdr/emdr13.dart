...
class WhatMoreHappened extends StatefulWidget {
  @override
  _WhatMoreHappenedState createState() => _WhatMoreHappenedState();
}

class _WhatMoreHappenedState extends State<WhatMoreHappened>
    ...
    if (controller.isCompleted == true) {
      SchedulerBinding.instance.addPostFrameCallback((_) {
        Navigator.pushAndRemoveUntil(
            context,
            MaterialPageRoute(
                builder: (BuildContext context) => VibrationPage2()),
            (route) => false);
      });
    }
    return WillPopScope(
      onWillPop: () => Navigator.push(
          context, MaterialPageRoute(builder: (context) => VibrationPage())),
      child: Scaffold(
