...
import 'package:eye_buddy/screen/training_regime/emdr/accumodation_tips.dart';
...
class AccommodationSpasm extends StatefulWidget {
  @override
  _AccommodationSpasmState createState() => _AccommodationSpasmState();
}

class _AccommodationSpasmState extends State<AccommodationSpasm> {
  String uid;
  String aCollection = "AcASTP";
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => ExerciseSet('accommodation')));
                },
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => AccommodationTips()));
                },
