import 'package:eye_buddy/screen/training_regime/emdr/lazy_eye_tips.dart';
...
class LazyEyeTreatment extends StatefulWidget {
  @override
  _LazyEyeTreatmentState createState() => _LazyEyeTreatmentState();
}

class _LazyEyeTreatmentState extends State<LazyEyeTreatment> {
  String uid;
  String aCollection = "AcLETP";
          ...
          child: Column(
            children: [
              InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => ExerciseSet('lazyeye')));
                },
              ...
              InkWell(
                onTap: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => LazyEyeTips()));
                },
