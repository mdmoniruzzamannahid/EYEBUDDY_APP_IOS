...
class LightSensitivityRight extends StatefulWidget {
  int counter;
  int id;
  LightSensitivityRight({this.id, this.counter});
  @override
  _LightSensitivityRightState createState() =>
      _LightSensitivityRightState(id: id, counter: counter);
}

class _LightSensitivityRightState extends State<LightSensitivityRight> {
  int id;
  int counter;
  _LightSensitivityRightState({this.id, this.counter});
  int counter2 = 0;
