...
class ColorBlindRight extends StatefulWidget {
  int id;
  int counter;
  ColorBlindRight({this.id, this.counter});
  @override
  _ColorBlindRightState createState() =>
      _ColorBlindRightState(id: id, counter: counter);
}

class _ColorBlindRightState extends State<ColorBlindRight> {
  int id;
  int counter;
  _ColorBlindRightState({this.id, this.counter});
          ...
          children: [
            Center(
              child: Container(
                ...
                width: 334,
                child: Image.asset(
                    'assets/eye_test/color_blind/vision${tap == 0 ? 1 : tap == 1 ? 2 : tap == 2 ? 3 : tap == 3 ? 4 : tap == 4 ? 5 : 6}.png'),
              ),
            ),
            Padding(
